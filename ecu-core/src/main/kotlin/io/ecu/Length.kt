 ...
 * Length meters = ECU.length(5.5, "m");
 * System.out.println(length.to("m")); // "1.0 m"
 * ```
 */
public class Length private constructor(
    baseValue: Double,
    symbol: String,
    displayName: String,
    precision: Int = -1,
    ...
    companion object {
         ...
         */
        @JvmStatic
        public fun of(value: Double, unit: String): Length {
         ...
         */
        @JvmStatic
        public fun meters(value: Double): Length {
         ...
         */
        @JvmStatic
        public fun centimeters(value: Double): Length {
         ...
         */
        @JvmStatic
        public fun inches(value: Double): Length {
         ...
         */
        @JvmStatic
        public fun feet(value: Double): Length {
