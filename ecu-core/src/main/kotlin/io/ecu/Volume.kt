 ...
 * Java 사용 예:
 * ```java
 * Volume volume = ECU.volume("250 ml");
 * Volume liters = ECU.volume(3.5, "l");
 * System.out.println(volume.to("l")); // "0.25 l"
 * ```
 */
public class Volume private constructor(
    baseValue: Double,
    symbol: String,
    displayName: String,
    precision: Int = -1,
